...
public class Log_OC {
    ...
    private static String mCalldriveDataFolderLog;
    ...
    public static String getLogPath() {
        return mCalldriveDataFolderLog;
    }
    ...
    synchronized public static void startLogging(Context context) {
        mCalldriveDataFolderLog = context.getFilesDir().getAbsolutePath() + File.separator + LOG_FOLDER_NAME;
        mFolder = new File(mCalldriveDataFolderLog);
        ...
        if (!mFolder.exists()) {
            ...
            Log.d(TAG, "Log folder created at: " + mCalldriveDataFolderLog);
        } else {
