...
system './gradlew compileDebugSources spotbugsReport'
...
current_warning_count = `grep -A 3 "Total</b>" build/reports/spotbugs/spotbugs.html | tail -n1 | cut -f2 -d">" | cut -f1 -d"<"`.to_i
...
system ("git config --local user.email 'android@calldrive.com'")
system ("git remote rm origin")
system ("git remote add origin https://" + git_user + ":" + git_token + "@github.com/calldrive/android-library")
